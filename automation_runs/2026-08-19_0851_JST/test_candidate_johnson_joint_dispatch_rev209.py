...
def test_rev209_joint_relation_dispatch_closes_j10_4_above_old_ground_cap():
    ...
    # Eight individually encoded ground anchors leave exactly the swap of the
    # two unanchored ground points, so the full k-subset string stabilizer is S2.
    assert new.coset.subgroup.order == 2
