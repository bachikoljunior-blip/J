    ...
    *,
    ...
    if h5.status != "undetermined_log_certificate_design_gate":
        return W1RH6LogDesignProof(
            "delegated_" + h5.status, h5.coset, h5, None,
            h5.ground_size, h5.subset_size, h5.test_arity, h5.test_count,
            h5.theorem_parameter_gate, h5.exact, h5.local_cost_certified,
    ...
    design = design_lemma_candidate_string_isomorphism(
        group, lift.lifted_generators, v, t,
        source_relation, target_relation, source, target,
        root_n=root_n,
        alpha=alpha,
    ...
    explicit_bound = h5.local_log2_cost_bound + design.local_log2_cost_bound + 8.0 * log2(max(2, root_n)) + 32.0
    if not design.exact:
        return W1RH6LogDesignProof(
            "undetermined_w1r_h6_design_candidate", None, h5, design,
            v, k, t, test_count,
            bool(h5.theorem_parameter_gate and design.theorem_hypotheses_certified),
            False, False, explicit_bound,
    ...
    return W1RH6LogDesignProof(
        "exact_w1r_h6_design_full_string", coset, h5, design,
        v, k, t, test_count,
        bool(h5.theorem_parameter_gate and design.theorem_hypotheses_certified),
        True, False, explicit_bound,
