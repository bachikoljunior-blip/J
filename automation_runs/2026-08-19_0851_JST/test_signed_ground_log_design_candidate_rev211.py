...
def test_rev211_signed_ground_terminal_closes_large_ground_candidate_left_by_u3():
...
def test_rev211_preserves_nontrivial_right_coset_coordinates():
    G, _ = pgl2_8_on_pairs()
    r = _swap(36, 0, 1)
...
def test_rev211_signed_ground_can_prove_exact_empty_with_equal_inventory():
    G, _ = pgl2_8_on_pairs()
    candidate = RightCoset(G, identity(36))
    source = tuple(range(36))
